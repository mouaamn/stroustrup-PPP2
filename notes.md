...
The std::vector is called an “STL container.”
...
Instead of a guarantee, we could use the RAII technique. By using something like std::unique_ptr, or creating our own UDT that uses RAII.  
...
Iterators don't allow subscripting, addition, or subtraction, only what we call “iterator operations” such as incremention.