/*
	Guesstimation?: 
		2^32/-1 = 2147483647;
		First, we try out a big n such as 500, 
		then we find where the first garbage-value occured. 
		After which we can find the maximum number.

		for x = 1, y = 2, the answer 27.
*/
